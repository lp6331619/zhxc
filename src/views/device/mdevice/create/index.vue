    ...
    <div class="app-container">
        <el-card class="box-card">
            <div
                ...
                class="clearfix"
            >
                <a @click="$router.push(`/mdevice`)"><i class="el-icon-back"></i>返回 | 监控详情 </a>
            </div>
            <el-form
                ref="setDetail"
                v-loading="loading"
            ...
            >
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        ...
                        >
                            <el-select
                                v-model="form.partition_type"
                                placeholder="请选择区名"
                            >
                                <el-option
                                    v-for="item in prepare.list"
                                    :key="item.partition_type"
                                    :label="item.partition_type"
                                    :value="item.partition_type"
                                >
                                </el-option>
                            </el-select>
                        </el-form-item>
                    ...
                    <el-col :span="12">
                        ...
                        >
                            <el-input
                                ...
                                placeholder="请输入设备标识符(注：只能填写数值：0～65535)"
                                :disabled="disabled"
                            ></el-input>
                        </el-form-item>
                    </el-col>
                    ...
                    >
                        ...
                        >
                            <el-option
                                v-for="item in prepare.mdevices"
                                :key="item.id"
                        ...
                        <el-form-item label=" ">
                            ...
                            >
                                <Canvas
                                    ...
                                    :partition_type="form.partition_type"
        ...
        <formDia
            v-if="formStatus && form.partition_type"
            :status="formStatus"
            :scene="statusType"
            :mesh="mesh.children"
            :siteid="form.partition_type"
            @emitOut="outForm"
        />
    </div>
</template>
